/* ALETHEIA — события сайта (20.09).
   ...
   действия. Содержимое заявок, контакты, описания инфраструктуры, пароли, ключи
   и любые введённые пользователем значения в аналитику НЕ уходят — ни в параметрах,
   ни в имени события. Единственный текстовый параметр — заголовок вопроса FAQ,
   это наш собственный текст со страницы, а не данные посетителя. Добавляя новое
   событие, проверь, что в params не попадает ничего из полей формы. */
(function(){
  'use strict';
